...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO passbook (details,credit,user,date_transaction ) VALUES ('$details','$amount','$name','$date')";
    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Successfully Withdrawal")</script>';
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }

    Print '<script>alert("Successful Withdrawal.")';
} 
?>

<?php include 'staff_header.php'; ?>
<h2 class="heading">WITHDRAWAL PAGE</h2>
                ...
                <form action="" method="POST">                 
                    <table border="0">
                        ...
                        <tbody>
                            ...
                            <tr>            
                                <td colspan="2"><p>Please don't withdraw more than customer's balance.</p></td>
                            </tr>
                            <tr>
                                <td><input type="submit" class="btn btn-success"  name="submit" value="Withdraw Money"/></td>
